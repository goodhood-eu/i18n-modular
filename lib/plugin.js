  ...
  apply(compiler) {
    ...
    compiler.hooks.compilation.tap(PLUGIN_NAME, (compilation, { normalModuleFactory }) => {
      ...
      compilation.hooks.finishModules.tapPromise(PLUGIN_NAME, async(modules) => {
        ...
        const builtModules = modulesArray.reduce((acc, webpackModule) => {
        ...
        const promises = modulesArray.reduce((acc, webpackModule) => {
    ...
    if (emitFile) {
      compiler.hooks.emit.tap(PLUGIN_NAME, (compilation) => {
        ...
        Array.from(compilation.modules.values())
          .reduce((acc, webpackModule) => {
            if (dictionaryRegex.test(webpackModule.resource)) acc.push(webpackModule.resource);
            return acc;
          }, [])
