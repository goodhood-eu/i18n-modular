...
const getRandomSortedObject = (source) => (
  Object.keys(source)
...
const runCallbackTimesSync = (fn, times = 10000) => {
...
describe('utils', () => {
  ...
  it('getSortedObject', () => {
    runCallbackTimesSync(() => {
      const obj = getRandomSortedObject({
        a: 1,
        a_1: 1,
        a_b: 1,
        ab_c: 1,
      ...
      const expected = { a: 1, abc_1: 3.5, abc: 4, ab_c: 3, a_b: 2 };

      const deepObj = getRandomSortedObject({
        deep: obj,
        a: 1,
        a_b: 2,
        ab_c: 3,
